...
const BlogCommentTest = () => {
    ...
    const [liked, setLiked] = useState(0);// holds the value of likes
    const [disliked, setDisliked] = useState(0);// holds the value of dislikes
    const [likeClicked, setLikeClicked] = useState(false);// holds the boolean value of likes
    const [dislikeClicked, setDislikeClicked] = useState(false);// holds the boolean value of likes
                    ...
                    <div>
                        ...
                        <div className="flex">
                            ...
                            <div className="" onClick={() => handleLikeButton(comment.id)}>
                                like{/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5">
                            ...
                            dislike{/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5">
